...
const RootComponent = (props) => {
  ...
  //   let x = cart.products.find((product) => (product.id = newProduct.id));
  //   console.log(`found product with id, return`, x);
  //   console.log(`add product with this obj`, newProduct);
  //   let updatedProduct = {
  //     id: x.id,
  //     qty: x.qty + 1,
  //     price: x.price + newProduct.price,
  //     title: x.title,
  //   };
  ...
  //         console.log(`update Product w this value`, updatedProduct);
  //         return updatedProduct;
  //       } else {
  //         console.log(`keep product`, product);
  //         return product;
  //       }
  //     }),
  //   });
  ...
  //   let x = cart.products.find((product) => (product.id = productRemoved.id));
  //   console.log(`remove product`, productRemoved);
  //   let updatedProduct = {
  //     id: x.id,
  //     qty: x.qty - 1,
  //     price: x.price - productRemoved.price,
  //     title: x.title,
  //   };
  ...
  //     ...cart,
  //     products: cart.products.map((product) => {
  //       return product.id === productRemoved.id ? updatedProduct : product;
  //     }),
  //   });
  // };
